    ...
    <div class="modal-body">
        ...
        <div class="form-group" id="add_card_text_group" style="padding-top: 20px;">
            ...
            <div class="input-group col-sm-9" style="padding-right: 15px;">
                ...
                <input type="text" ng-model="text" id="add_card_text" placeholder="Text" required autofocus tabindex="1" class="form-control">
            </div>
        </div>
        <div class="form-group" id="add_card_tooltip_group">
            ...
            <div class="input-group col-sm-9" style="padding-right: 15px;">
                ...
                <input type="text" ng-model="tooltip" id="add_card_tooltip" placeholder="Tooltip" tabindex="2" class="form-control">
            </div>
        </div>
    </div>
